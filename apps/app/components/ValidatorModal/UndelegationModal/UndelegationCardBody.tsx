      ...
      <ul role="list" className="flex">
        <li key="1" className="py-4">
          <div className="flex flex-col gap-1">
            <h3 className="uppercase text-transparent text-xs font-medium bg-clip-text bg-gradient-20 from-gradientStart to-gradientStop">Available for Undelegation</h3>
            <h1 className="text-lg text-textPrimary font-semibold">{displayNom(selectedValidator.amountStaked) + ' oraibtc'}</h1>
          </div>
        </li>
      </ul>
    </div>
