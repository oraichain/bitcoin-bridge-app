        ...
        <div className="flex flex-col justify-center gap-8">
          <div className="w-full text-center text-textPrimary text-2xl flex flex-col gap-6">
            ...
            <div className="w-full flex flex-col gap-2">
              <h2>{'≈ ' + displayBtc(bitcoin.selectedTransaction.resolveAmount())}</h2>
              <h3 className="italic text-sm text-textSecondary gap-2">*Funds will become available after {Transaction.numConfirmations} confirmations</h3>
            </div>
          </div>
          ...
          <div className="flex flex-col text-sm text-textPrimary">
            <div className="flow-root mb-2">
              ...
              <h3 className="float-right">{displayBtc(bitcoin.selectedTransaction.amount)}</h3>
            </div>
            <div className="flow-root mb-2">
            ...
            <div className="flow-root">
              ...
              <h3 className="float-right">{displayBtc(bitcoin.selectedTransaction.resolveFeeAmount())}</h3>
            </div>
          </div>
          <Button
