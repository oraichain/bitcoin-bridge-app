  ...
  return (
    <div ref={wrapperRef} className="flex flex-col">
      <div ref={contentRef} className="relative flow-root">
        <div ref={breakRef} className="relative float-left w-screen bg-background z-0 imageBreak -mt-24">
          <div ref={shardsRef} className="absolute grid grid-cols-5 grid-rows-4 w-screen">
            <div id="shardBlur7" className="col-start-5 row-start-2 opacity-90 text-right">
              <div className="">
        ...
        <div className="absolute flex justify-center items-center w-1/2 top-0 right-0 shadow-sm rounded-lg bg-surface -mt-24 mr-12">
          <div className="flex flex-col text-left gap-4 m-16">
            <h2 className="text-transparent text-sm bg-clip-text bg-gradient-20 from-gradientStart to-gradientStop">ORGA</h2>
            <h1 className="text-3xl font-extralight">
              New Blockchain <span className="font-medium"> stack </span>
            </h1>
            <p className="text-textSecondary font-light">
              OraiBtcSubnet is built on <b>Orga</b>, a custom high-performance blockchain application framework. Orga is written in Rust, and engineered from the ground up for maximum performance and security.
            </p>
            <p className="text-textSecondary font-light">
              {`This boosts OraiBtcSubnet's performance up to 100x higher than other
